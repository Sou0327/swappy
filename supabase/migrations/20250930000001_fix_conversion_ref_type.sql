-- 両替機能のref_type修正
-- ref_typeを'conversion'から'system'に変更してCHECK制約をクリア
...
BEGIN
  ...
  BEGIN
    ...
    -- ref_typeは'system'を使用（CHECK制約: order, trade, deposit, withdrawal, system）
    -- 両替元のエントリ（減額：手数料込み）
...
COMMENT ON FUNCTION execute_conversion_with_fee IS '修正版: ref_typeをsystemに変更してledger_entriesのCHECK制約をクリア';